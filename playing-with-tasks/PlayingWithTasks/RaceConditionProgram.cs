namespace PlayingWithTasks.RaceCondition
{
    internal class RaceConditionProgram
    {
    ...
    public class BankAccount
    {
        ...
        {
            //Il ritardo artificiale nelle operazioni
            //aumenta la probabilità che i due thread interagiscano in modo
            //imprevedibile con la variabile condivisa saldo
